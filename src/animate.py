...
def animateFromSurprised(img, image, robotOn):
    ...
    for i in range(maxChange):
        ...
        if i < mouthMaxChange and i > 0:
            ...
            if i < 8:
                cv.ellipse(img,(512,upperMouthY1),(upperMouthX2,upperMouthY2),0,190,350,backgroundColor,thickness=4) #upperMouthArch
                if i < 7:
                    ...
                    cv.ellipse(img,(512,upperMouthY1),(upperMouthX2,upperMouthY2),0,190,350,faceColor,thickness=4) #upperMouthArch

            #Animate Lower Mouth
            cv.ellipse(img,(512,lowerMouthY1),(lowerMouthX2,lowerMouthY2),180,220,320,backgroundColor,thickness=4) #lowerMouthArch
            ...
            cv.ellipse(img,(512,lowerMouthY1),(lowerMouthX2,lowerMouthY2),180,220,320,faceColor,thickness=4) #lowerMouthArch

        #Bottom eye arch animation to neutral eyes
        if i >= maxChange - bottomEyeArchMaxChange:
            cv.ellipse(img,(280,bottomEyeCenterY1),(200,180),180,250,290,backgroundColor,thickness=4) #leftBottomEyeArch
            cv.ellipse(img,(744,bottomEyeCenterY1),(200,180),180,250,290,backgroundColor,thickness=4) #rightBottomEyeArch
            bottomEyeCenterY1 = bottomEyeCenterY1 - 3
            cv.ellipse(img,(280,bottomEyeCenterY1),(200,180),180,250,290,faceColor,thickness=4) #leftBottomEyeArch
            cv.ellipse(img,(744,bottomEyeCenterY1),(200,180),180,250,290,faceColor,thickness=4) #rightBottomEyeArch
        
        #Eyebrow animation to neutral eyebrows
        if i >= maxChange - eyebrowMaxChange:
            cv.ellipse(img,(280,eyebrowY1),(190,eyebrowY2),0,225,305,backgroundColor,thickness=5) #leftEyebrow
            cv.ellipse(img,(744,eyebrowY1),(190,eyebrowY2),0,235,315,backgroundColor,thickness=5) #rightEyebrow
            eyebrowY1 = eyebrowY1 - 15
            eyebrowY2 = eyebrowY2 - 20
            cv.ellipse(img,(280,eyebrowY1),(190,eyebrowY2),0,225,305,faceColor,thickness=5) #leftEyebrow
            cv.ellipse(img,(744,eyebrowY1),(190,eyebrowY2),0,235,315,faceColor,thickness=5) #rightEyebrow
        
        #Upper eye animation to neutral eyes
        if i >= maxChange - upperEyeArchMaxChange:
            cv.ellipse(img,(744,archY1),(180,archY2),0,235,325,backgroundColor,thickness=4) #rightUpperEyeArch
            cv.ellipse(img,(280,archY1),(180,archY2),0,215,305,backgroundColor,thickness=4) #leftUpperEyeArch
            archY1 = archY1 - 2
            archY2 = archY2 - 5
            cv.ellipse(img,(744,archY1),(180,archY2),0,235,325,faceColor,thickness=4) #rightUpperEyeArch
            cv.ellipse(img,(280,archY1),(180,archY2),0,215,305,faceColor,thickness=4) #leftUpperEyeArch
        ...
        if i >= maxChange - eyeSideLineMaxChange:
            ...
            cv.line(img,(132,eyeLineY1),(170,eyeLineY2),faceColor,thickness=4) #leftEyeSideLine
...
def animateFromSad(img, image, robotOn):
    ...
    for i in range(maxChange):
        ...
        if i >= maxChange - mouthMaxChange:
            cv.ellipse(img,(512,mouthY1),(95,mouthY2),mouthAxes,220,320,backgroundColor,thickness=4)
            if mouthCurvedDown:
                mouthY1 = mouthY1 - 15
                mouthY2 = mouthY2 - 17
            else:
            ...
            if mouthY2 == 0:
                ...
                mouthAxes = 180
            cv.ellipse(img,(512,mouthY1),(95,mouthY2),mouthAxes,220,320,faceColor,thickness=4)
        ...
        #Eyebrow animation to neutral eyebrows
        if i >= maxChange - eyebrowMaxChange:
            cv.ellipse(img,(280,eyebrowY1),(190,eyebrowY2),eyebrowAxes,startAngleL,endAngleL,backgroundColor,thickness=5) #leftEyebrow
            cv.ellipse(img,(744,eyebrowY1),(190,eyebrowY2),eyebrowAxes,startAngleR,endAngleR,backgroundColor,thickness=5) #rightEyebrow
            ...
            cv.ellipse(img,(280,eyebrowY1),(190,eyebrowY2),eyebrowAxes,startAngleL,endAngleL,faceColor,thickness=5) #leftEyebrow
            cv.ellipse(img,(744,eyebrowY1),(190,eyebrowY2),eyebrowAxes,startAngleR,endAngleR,faceColor,thickness=5) #rightEyebrow
...
def animateFromAngry(img, image, robotOn):
    ...
    for i in range(maxChange):
        ...
        if i < mouthMaxChange:
            cv.ellipse(img,(512,mouthY1),(95,mouthY2),mouthAxes,mouthStartAngle,mouthEndAngle,backgroundColor,thickness=4)
            if i > 8:
                if mouthCurvedDown:
                    mouthY1 = mouthY1 - 15
                    mouthY2 = mouthY2 - 17
            ...
            cv.ellipse(img,(512,mouthY1),(95,mouthY2),mouthAxes,mouthStartAngle,mouthEndAngle,faceColor,thickness=4)
        ...
        if i == 2:
            cv.ellipse(img,(280,268),(100,80),lIrisRotation,lUpperIrisStartAngle,lUpperIrisEndAngle,eyeColor,thickness=4) #leftIris
            cv.ellipse(img,(744,268),(100,80),rIrisRotation,rUpperIrisStartAngle,rUpperIrisEndAngle,eyeColor,thickness=4) #rightIris
        ...
        if i < upperEyeArchMaxChange + 1 and i > 1:
            cv.ellipse(img,(280,upperIrisCenterY),(100,80),lIrisRotation,lUpperIrisStartAngle,lUpperIrisEndAngle,eyeColor,thickness=3) #leftIris
            cv.ellipse(img,(744,upperIrisCenterY),(100,80),rIrisRotation,rUpperIrisStartAngle,rUpperIrisEndAngle,eyeColor,thickness=3) #rightIris
        ...
        if i >= maxChange - eyebrowMaxChange:
            cv.ellipse(img,(280,nEyebrowY1),(190,eyebrowY2),lEyebrowRotation,startAngleL,endAngleL,backgroundColor,thickness=5) #leftEyebrowStraightPiece
            cv.ellipse(img,(744,nEyebrowY1),(190,eyebrowY2),rEyebrowRotation,startAngleR,endAngleR,backgroundColor,thickness=5) #rightEyebrowStraightPiece
            if i < 9:
                cv.ellipse(img,(280,eyebrowY1),(190,nEyebrowY2),lEyebrowRotation,215,startAngleL,backgroundColor,thickness=5) #leftEyebrowCurvedPiece
                cv.ellipse(img,(744,eyebrowY1),(190,nEyebrowY2),rEyebrowRotation,endAngleR,325,backgroundColor,thickness=5) #rightEyebrowCurvedPiece
            ...
            if i == 8:
                ...
                eyebrowY1 = eyebrowY1 - 6
            if i < 8:
                cv.ellipse(img,(280,eyebrowY1),(190,nEyebrowY2),lEyebrowRotation,215,startAngleL,faceColor,thickness=5) #leftEyebrow
                cv.ellipse(img,(744,eyebrowY1),(190,nEyebrowY2),rEyebrowRotation,endAngleR,325,faceColor,thickness=5) #rightEyebrow
        ...
        if i < eyeSideLineMaxChange and i > 0:
            ...
            cv.line(img,(lEyeLineX1,nEyeLineY1),(lEyeLineX2,nEyeLineY2),faceColor,thickness=4) #leftEyeSideLine
...
def animateToAngry(img, image, robotOn):
    ...
    for i in range(maxChange):
        ...
        #Eyebrow animation to angry eyebrows
        if i >= maxChange - eyebrowMaxChange:
            cv.ellipse(img,(280,nEyebrowY1),(190,eyebrowY2),lEyebrowRotation,startAngleL,endAngleL,backgroundColor,thickness=5) #leftEyebrow
            cv.ellipse(img,(744,nEyebrowY1),(190,eyebrowY2),rEyebrowRotation,startAngleR,endAngleR,backgroundColor,thickness=5) #rightEyebrow
            if i > 7:
                cv.ellipse(img,(280,eyebrowY1),(190,nEyebrowY2),lEyebrowRotation,215,startAngleL,backgroundColor,thickness=5) #leftEyebrow
                cv.ellipse(img,(744,eyebrowY1),(190,nEyebrowY2),rEyebrowRotation,endAngleR,325,backgroundColor,thickness=5) #rightEyebrow
            if eyebrowY2 > 20:
                eyebrowY2 = eyebrowY2 - 5
            lEyebrowRotation = lEyebrowRotation + 2
            rEyebrowRotation = rEyebrowRotation - 2
...
animateFromDict = {'s': animateFromSurprised, 'd': animateFromSad, 'a': animateFromAngry, 'h': animateFromHappy}
