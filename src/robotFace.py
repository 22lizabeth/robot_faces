...
class robotFace:
    def __init__(self, image=False, robotOn=True, dictPath="cmudict-modified.txt"):
        ...
        self.animateObj = Animate(
            self.img, self.faceDisplay, self.drawObj, self.image, self.robotOn)
        ...
        self.speachObj = Speech_Animation(
            self.img, self.faceDisplay, self.drawObj, self.image, self.robotOn, dictPath)
